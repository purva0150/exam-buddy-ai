      ...
      >
        <div className="text-center space-y-2">
          <div className="w-10 h-10 rounded-lg bg-primary flex items-center justify-center mx-auto">
            <span className="text-primary-foreground text-sm font-semibold">ED</span>
          </div>
          <h1 className="text-xl font-semibold">EDAS</h1>
          <p className="text-sm text-muted-foreground">Exam Duty Allocation System</p>
        </div>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <Button type="submit" className="w-full press-effect" disabled={loading}>
        ...
        <Button variant="outline" className="w-full press-effect" onClick={handleGoogleLogin}>
